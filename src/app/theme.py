"""LineTwin visual theme: dark, Accenture-branded.

Palette uses Accenture purple (#A100FF), charcoal, and white. Distinctions
that used to rely on separate hues now use fill vs. outline, solid vs.
dashed borders, and weight/opacity instead of extra colors.

Fonts: EB Garamond for headings/titles, Courier New for body/UI text.
Streamlit's native dataframe/table widget is intentionally left alone
(its font isn't overridden here).
"""
